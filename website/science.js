...
window.ScienceChapter = (() => {
  ...
  function html(cite){
    const bodies=[
      ...
      panel(1,'SOCIAL & BEHAVIOURAL SCIENCES CYCLE',`<p class="story-arrow">Market need → Scientific exploration</p><p class="story-lead">Amar Bose turns a listening problem into a research programme. Our CIM reading: user experience sets the question; acoustic findings set the requirements.</p>${cite(7,9)}`)
    ];
