...
const sections = [
 ...
 {id:'cim',name:'Entrepreneurship at the hub',chapter:'05 / WHO CONNECTED THE WORK?',speaker:'F',html:`<div class="cim-layout"><div class="cim-copy"><p class="eyebrow reveal">ENTREPRENEURSHIP</p><h2 class="reveal">Connect expertise.<br><em>Act on feedback.</em></h2><div class="entrepreneur-actions"><article class="reveal"><span>01</span><div><h3>Support the work. Bring in expertise.</h3><p>After an early engineer concluded it would not work, Amar Bose hired Sapiejewski; Gauger joined with control and circuit skills.</p></div></article><article class="reveal"><span>02</span><div><h3>Act on marketing’s cost objection.</h3><p>With Bose’s support, the engineers explored specialist applications when the consumer offer was too expensive.</p></div></article><article class="reveal"><span>03</span><div><h3>Protect the shared investment.</h3><p>Patents record product objectives and protection efforts. Private ownership supports patient research; profit and the full funding mix are not established.</p></div></article></div></div><div class="cim-figure">${cim}<p class="scope">Redrawn from ET5218 lecture 01, slide 27, adapted from Berkhout, Hartmann & Trott (2010). Bose connections are our interpretation. ${cite(1,8,9,11,19,20)}</p></div></div><p class="scope reveal">Evidence: Gauger’s first-person account, patents and company history. Private ownership provides context, not a disclosed ANC funding budget.</p>`},
 {id:'cycle',name:'Timeline versus cycle',chapter:'06 / WHAT MOVED, AND WHAT CHANGED?',speaker:'F',html:`<div class="section-heading"><p class="eyebrow reveal">THE ANALYTICAL DIFFERENCE</p><h2 class="reveal">Nineteen years from prototype<br>to consumer product. <em>Why?</em></h2></div><div class="comparison"><div class="timeline-column"><span class="column-title">THE COMMERCIALISATION GAP</span><div><b>1981</b><p>A working prototype; an unaffordable consumer offer.</p></div><div><b>Constraint</b><p>Cost, size and comfort still limit the product.</p></div><div><b>Learning</b><p>Engineering and customer trials change the offer.</p></div><div><b>2000</b><p>Consumer QuietComfort reaches the market.</p></div></div><div class="flow-column"><span class="column-title">CIM / INFORMATION → ACTION → IMPLICATION</span><article><span class="flow-dot science-dot"></span><div><b>Market → Science: define the problem</b><p>Amar Bose turns a listening need into a research programme.</p></div><span class="evidence-pill">DOCUMENTED ORIGIN</span></article><article><span class="flow-dot technology-dot"></span><div><b>Science ↔ Technology: test the explanation</b><p>Acoustic theory guides control; measurements expose questions for further investigation.</p></div><span class="evidence-pill">CIM INTERPRETATION</span></article><article><span class="flow-dot product-dot"></span><div><b>Technology ↔ Product: reconcile requirements</b><p>Packaging requirements guide acoustics; TriPort helps enable the consumer form.</p></div><span class="evidence-pill">CIM INTERPRETATION</span></article><article><span class="flow-dot market-dot"></span><div><b>Product ↔ Market: learn from trial</b><p>The airline partnership exposes the product; passenger response informs consumer sales.</p></div><span class="evidence-pill">COMPANY ACCOUNT</span></article></div></div><div class="takeaway reveal"><span>OUR CIM READING</span><p>Documented events; interpreted feedback.<br><em>Development progressed unevenly.</em></p>${cite(7,9,11)}</div>`},
...
const steppedChapters = {opening: IntroChapter, science: ScienceChapter, technology: TechnologyChapter, product: ProductChapter, market: MarketChapter, conclusion: ConclusionChapter};
