...
window.ProductChapter = (() => {
  ...
  const slides = [
    ...
    {id:'design',short:'Design choices',label:'Requirements change the design',title:'Performance<br><em>people can wear.</em>',caption:'QC25 illustrates the trade-offs. Features matter through their consequences for the user.',intro:'The product balance',choices:[
