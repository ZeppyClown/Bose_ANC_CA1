...
window.TechnologyChapter = (() => {
  const steps = [
    ...
    {id:'research',label:'Science ↔ Technology',title:'Science and technology<br><em>inform each other.</em>',copy:'Natural & life sciences cycle: theory guides control design; prototype measurements expose questions. Early Bose ANC was analogue; Gauger dates digital consumer ANC to QC20 (2013). Our CIM interpretation.',refs:[3,9]}
  ];
